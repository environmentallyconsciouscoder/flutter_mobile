...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<CollectionService>(onMissingStub: OnMissingStub.returnDefault),
  ...
  MockSpec<UpgraderService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockCollectionService getAndRegisterCollectionService() {
  _removeRegistrationIfExists<CollectionService>();
  final service = MockCollectionService();
  locator.registerSingleton<CollectionService>(service);
  return service;
}
...
MockUpgraderService getAndRegisterUpgraderService() {
  _removeRegistrationIfExists<UpgraderService>();
  final service = MockUpgraderService();
  locator.registerSingleton<UpgraderService>(service);
  return service;
}
// @stacked-mock-create
